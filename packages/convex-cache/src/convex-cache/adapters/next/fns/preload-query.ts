...
export type PreloadQueryReturn<Q extends Q_Query | PQ_Query> = Q extends PQ_Query
  ? PQ_CachedResult<Q> | undefined
  : Q_Result<Q> | undefined;
...
export async function preloadQuery<Q extends Q_Query | PQ_Query>(
  params: T_PreloadQueryParams<Q>,
